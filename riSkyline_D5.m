...
all_nPoints = [pos_D5.kgd.nPoints;neg_D5.kgd.nPoints];
nPoints_D5 = all_nPoints(idx_Old);
...
conc_table_D5 = splitvars(table(mtabNames_D5,r2_line_D5,nPoints_D5,LOD_D5_conc,LOQ_D5_conc,mtabData_D5_conc));
conc_table_D5.Properties.VariableNames = [{'Metabolite','r2_line','nPoints','LOD','LOQ'},sInfo_D5.cName'] ;
...
conc_table_D5_filtered = splitvars(table(mtabNames_D5,r2_line_D5,nPoints_D5,LOD_D5_conc,LOQ_D5_conc,mtabData_D5_conc_filtered));
conc_table_D5_filtered.Properties.VariableNames = [{'Metabolite','r2_line','nPoints','LOD','LOQ'},sInfo_D5.cName'] ;
